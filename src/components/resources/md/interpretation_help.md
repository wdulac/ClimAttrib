...
Return periods are defined as the inverse of the frequency of occurrence (i.e probabilities). For example, a 10-year heatwave has a 1/10 = 0.1 or 10% chance of being exceeded each year.